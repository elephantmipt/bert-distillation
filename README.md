...
_For more general pipeline please follow [compressors](https://github.com/elephantmipt/compressors) library and [BERT distillation example](https://github.com/elephantmipt/compressors/blob/master/examples/transformers). This project is not supported by me anymore._
